...
export default function Student() {
  ...
  const [iid,setIid]=useState(localStorage.getItem('studentid'));
...
useEffect(()=>{
        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            <Typography component="h1" variant="h2" align="center" color="textPrimary" gutterBottom>
              Hello {localStorage.getItem('student_name')}
            </Typography>
            ...
            {Data.map((item) =>{ 
              ...
              <Grid item key={item} xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  ...
                  <CardActions>
                    <Button size="small" color="primary" onClick={()=>{showpath(`${location.pathname}/${ID}`)}}>
  ...
  
  {
    ...
    :
    <Button size="small" color="primary" onClick={()=>{setSche(true)}}>
                      {/* Show Schedule */}
                    </Button>
  }
        </Container>
